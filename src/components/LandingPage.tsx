      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="group">
              <div className="text-3xl md:text-4xl font-bold text-blue-800 mb-2 group-hover:text-yellow-500 transition-colors">50+</div>
              <div className="text-gray-600">Countries Served</div>
            </div>
            <div className="group">
              <div className="text-3xl md:text-4xl font-bold text-blue-800 mb-2 group-hover:text-yellow-500 transition-colors">10K+</div>
              <div className="text-gray-600">Active Traders</div>
            </div>
            <div className="group">
              <div className="text-3xl md:text-4xl font-bold text-blue-800 mb-2 group-hover:text-yellow-500 transition-colors">$2B+</div>
              <div className="text-gray-600">Trade Volume</div>
            </div>
            <div className="group">
              <div className="text-3xl md:text-4xl font-bold text-blue-800 mb-2 group-hover:text-yellow-500 transition-colors">99.9%</div>
